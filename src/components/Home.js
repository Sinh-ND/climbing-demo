        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="add1">
              ...
              <div className="add11">
                <Link to="/organizations/success" className="link-item no-underline">
              ...
              <div className="add11">
                <Link to="/gallery/pictures" className="link-item no-underline">
              ...
              <div className="add11">
                <Link to="/about/types" className="link-item home-link1 no-underline">
          ...
          <div className="col-md-3">
            <div className="add1">
              <div className="add11">
                <Link to="/about/sheltering" className="link-item no-underline">
              ...
              <div className="add11">
                <Link to="/about/hazards" className="link-item no-underline">
              ...
              <div className="add11">
                <Link to="/records" className="link-item home-link1 no-underline">
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4">
            ...
            <div className="add11">
              <Link to="/HomeLink" className="link-item no-underline">
          ...
          <div className="col-md-4">
            <div className="add11">
              <Link to="Developments" className="link-item no-underline">
          ...
          <div className="col-md-4">
            ...
            <div className="add11">
              <Link to="/gallery/videos" className="link-item no-underline">
